...
<html>
    <%
        ...
        System.out.println(application.getRealPath("/reportes/ReporteClienteDispZona.jasper"));
        File file = new File(application.getRealPath("/reportes/ReporteClienteDispZona.jasper"));
