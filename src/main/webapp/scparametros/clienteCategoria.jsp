...
<html>
    <%
        ...
        String inicial=request.getParameter("categoria");
        ...
        parametros.put("categoria", inicial);
        //System.out.println(id);
        Connection conexion;
        Class.forName(driver);
        conexion = DriverManager.getConnection(connectString, user, password);
        System.out.println(application.getRealPath("/reportes/ReporteCategoria.jasper"));
        File file=new File(application.getRealPath("/reportes/ReporteCategoria.jasper"));
